...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=('[V1.61]rocminstall.py: utility to '
    ...
    print("Running V1.61 rocminstall.py utility for OS: " + ostype + " on: " + str(datetime.datetime.now()))

...
def get_deb_pkglist(rocmurl, revstring, pkgtype, ubuntutype):
    ...
    if ("3.9.1" in revstring or "4.0.1" in revstring or "4.1.1" in revstring
        ...
        or "5.4.1" in revstring or "5.4.2" in revstring
        or "5.4.3" in revstring or "5.4.4" in revstring):
...
def workaround_dummy_versionfile_deb(args, rocmbaseurl):
    ...
    if (args.revstring[0] == "3.9.1" or args.revstring[0] == "4.0.1" or args.revstring[0] == "4.1.1"
        ...
        or args.revstring[0] == "5.4.1" or args.revstring[0] == "5.4.2"
        or args.revstring[0] == "5.4.3" or args.revstring[0] == "5.4.4"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=('[V1.62]rocminstall.py: utility to '
    ...
    print("Running V1.62 rocminstall.py utility for OS: " + ostype + " on: " + str(datetime.datetime.now()))

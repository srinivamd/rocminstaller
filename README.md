...
```
# [Unofficial] V1.53 rocminstall.py Utility to install ROCm releases. Supports Ubuntu/Debian, CentOS/RHEL 7/8, SLES15 installation
...
[V1.53]rocminstall.py: utility to download and install ROCm packages for

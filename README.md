...
# [Supports 3.3, 3.5, 3.7, 3.8] V1.19 rocminstall.py Utility to install ROCm releases. Supports Ubuntu/Debian, CentOS/RHEL 7/8, SLES15 installation
...
[V1.19]rocminstall.py: utility to download and install ROCm packages for

...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=('[V1.18]amdgpuinst.py: utility to '
    ...
    print("Running V1.18 amdgpuinst.py utility for OS: " + ostype + " on: " + str(datetime.datetime.now()))
